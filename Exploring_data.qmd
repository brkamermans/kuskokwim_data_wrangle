...
We have downloaded the escapement data from ADF&G. We have explored the data file. We have filtered the data for the year 2023 and Chinook and Chum. We verified with data visualization to ensure we have the Chum and Chinook datasets we are looking for. The only data that isn't working is Takotna due to date column being different and need to work with lubridate to make a date that can be used.
